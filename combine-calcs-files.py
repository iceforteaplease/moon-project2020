...
# gets month/year for file names
import datetime
...
month_year_for_files = str_today[5:8] + str_today[:4]
# print(month_year_for_files)

# format ex. westlake_data_01-2020.txt
data_file_name = store + '_data_' + month_year_for_files + '.txt'
calcs_file_name = store + '_calcs_' + month_year_for_files + '.txt'
